...
class ueditor_control extends common_control {
	...
	public function on_uploadimage() {
		...
		if(!empty($_FILES['upfile']['tmp_name'])) {
			...
			//echo "{'url':'" . 'view/image/logo.gif' . "','title':'" . $title . "','original':'" . $file['name'] . "','state':'SUCCESS'}";
			exit;
		} else {
	...
	/*public function on_uploadfile() {
		...
		if(!empty($_FILES['upfile']['tmp_name'])) {
			...
			echo "{'url':'" . $uploadurl.$arr['filename'] . "', 'fileType': '".$ext."', 'original':'" . $file['name'] . "','state':'SUCCESS'}";
			//echo "{'url':'" . 'view/image/logo.gif' . "','title':'" . $title . "','original':'" . $file['name'] . "','state':'SUCCESS'}";
